...
- Value: A geographical area (sub area of county/lan) with special
  interest
...
Kungalv is an independent area by default. There are situations when
Kungalv should be dealt with as an independent health care region or as
a part of greater Gothenburg. See section "extra_functions" in
[decode](https://eribul.github.io/decoder/reference/decode.md) to handle
this.
...
[`hsn`](https://eribul.github.io/decoder/reference/hsn.md),
