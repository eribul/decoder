...
Key-value codes for the Swedish "laboratories". Data is combined from
two sources.

1.  The official list from SOFS 2006:15 (see url below). This is the
    primary source for codes appearing in both sources.

2.  Extra codes are also added from the old Rockan registry for
    historical reasons.
