...
Key-value codes for Snomed. Data from Rockan 2012-10-05. Note tht this
variable is the same as `snomed` from Rockan. It should not be confused
with the later version `snomed3`!
